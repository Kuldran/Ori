...
class Utilities {
    ...
    * NOTE: Exits!
    */
    public static function JsonExit($message = NULL, $success = FALSE, array $values = [], $boolean = TRUE) {
        if ($boolean === FALSE) {
            $success = ($success === TRUE) ? '1' : '0';
        }

        header('Content-Type: application/json; charset=utf-8');
        exit(print_r(json_encode(array_merge(['message' => $message, 'success' => $success], $values), JSON_UNESCAPED_UNICODE | JSON_PARTIAL_OUTPUT_ON_ERROR), TRUE));
    }
    ...
    */
    public static function HumanFileSize($bytes, $decimals = 2) {
        $size = [' Bytes',' KiloBytes',' MegaBytes',' GigaBytes',' TeraBytes',' PetaBytes'];
    ...
    */
    public static function FuzzyTime(DateTime $date, $invalid_past = 'a long time ago', $invalid_future = 'a long time from now') {
        $time_formats = [
            ...
            ['max' => 90, 'text' => '1 minute', 'past' => 'ago', 'future' => 'from now'],
            ['max' => 3600, 'text' => 'minutes', 'divider' => 60, 'past' => 'ago', 'future' => 'from now'],
            ['max' => 5400, 'text' => '1 hour', 'past' => 'ago', 'future' => 'from now'],
            ['max' => 86400, 'text' => 'hours', 'divider' => 3600, 'past' => 'ago', 'future' => 'from now'],
            ['max' => 129600, 'text' => '1 day', 'past' => 'ago', 'future' => 'from now'],
            ['max' => 604800, 'text' => 'days', 'divider' => 86400, 'past' => 'ago', 'future' => 'from now'],
            ['max' => 907200, 'text' => '1 week', 'past' => 'ago', 'future' => 'from now'],
            ['max' => 2628000, 'text' => 'weeks', 'divider' => 604800, 'past' => 'ago', 'future' => 'from now'],
            ['max' => 3942000, 'text' => '1 month', 'past' => 'ago', 'future' => 'from now'],
            ['max' => 31536000, 'text' => 'months', 'divider' => 2628000, 'past' => 'ago', 'future' => 'from now'],
            ['max' => 47304000, 'text' => '1 year', 'past' => 'ago', 'future' => 'from now'],
            ['max' => 3153600000, 'text' =>  'years', 'divider' => 31536000, 'past' => 'ago', 'future' => 'from now'],
        ];
    ...
    * @returns bool
    */
    public static function SendEmail($email, $subject, $message, array $parameters = []) {
        try {
