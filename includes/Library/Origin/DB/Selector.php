...
class Selector extends \Origin\Utilities\Types\Singleton {
    ...
    public function Query($table, Parameters $parameters = NULL, array $columns = [], $joins = NULL, $order_by = 'ID') {
    ...
    */
    ...
    protected function GenerateDigest(DatabaseAssistant $object, Parameters $parameters = NULL, $children = FALSE) {
        return sha1(json_encode(['object' => get_class($object), 'parameters' => $parameters, 'children' => $children]));
    }
